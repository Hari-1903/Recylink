        ...
        <div className="mx-1">
          <form action="">
            <div className="flex flex-col md:flex-row">
              <input type="text" id="fullName" required placeholder=" Full Name"  className="border-2 border-black w-full md:w-1/2 resize-none rounded-[30px] pt-3 pl-4 pr-4 pb-4 px-1 bg-gray-300 text-green-700 font-bold mb-4 md:mb-0" />
              <input type="email" id="mailId" required placeholder=" Mail Id"  className="border-2 border-black w-full md:w-1/2 resize-none rounded-[30px] pt-3 pl-4 pr-4 pb-4 px-1 bg-gray-300 text-green-700 font-bold md:ml-6" />
            </div>
            <div className="mt-6 text-green-700">
              <input type="text" id="subject" required placeholder=" Subject" className="border-2 border-black w-full resize-none rounded-[30px] pt-3 pl-4 pr-4 pb-4 px-1 bg-gray-300 text-green-700 font-bold" />
            </div>
            <div className="mt-6">
              <textarea id="message" name="" cols={20} rows={10} placeholder="Got a message for us?" className="border-2 border-black w-full resize-none rounded-[30px] pt-3 pl-4 pr-4 pb-4 px-1 bg-gray-300 text-green-700 font-bold"></textarea>
            </div>
