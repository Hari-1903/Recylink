...
const Contact = () => {
  return (
    <div className="grid grid-cols-[280px_1fr] h-screen w-screen">
      ...
      <div className="flex absolute top-[120px] w-[320px] h-[calc(100%-200px)] z-1 flex-col justify-between mx-20 my-5 p-[40px] bg-teritiary shadow-md rounded-md max-w-sm">
