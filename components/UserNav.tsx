    ...
    <div className='bg-white shadow-[0px_0px_10px_10px_rgba(0,0,0,0.1)] rounded-lg px-8 py-6 m-2 flex justify-between items-center'>
        ...
        <div className="flex-center gap-10">
            <div className="flex gap-4 max-md:gap-2">
                <Link href='/User/RaiseTicket'><p className="font-medium px-4 py-1 rounded-xl bg-[#fffff] text-[#000] hover:transition all 0.2s ease-in-out cursor-pointer hover:bg-teritiary ">Complaint</p></Link>
